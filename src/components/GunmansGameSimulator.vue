<template>
  <div>
    <section class="container">
      ...
      <div class="columns">
        <b-field v-for="i in players" v-bind:key="i" :label="'Hit Rate of Player' + i" class="column">
          <b-slider v-model="rate[i-1]" :min="0.00" :max="1.00" :step="0.01" lazy @change="render"
                    type="is-info"></b-slider>
        </b-field>
      </div>
      <div class="columns">
